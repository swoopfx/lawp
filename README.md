...
> host: localhost
> Database Name: lawp 
> Database Admin: http://24.144.90.222/phpmyadmin
>
...
> ORM : Doctrine
> Automation : Bash 
> Shell Script Location: /bin 
> Functionality: Most of the heavy duty work done with shell script and called from PHP
> Database Export: All export are dumped into /bin directory 

> ## Contraint
> Security: Some functionality do not meet minimum security standard however this is just a POC
